...
@Component({
  selector: 'app-signuppharmacist',
  templateUrl: './signuppharmacist.component.html',
  styleUrls: ['./signuppharmacist.component.css']
})
export class SignuppharmacistComponent implements OnInit {
  form: FormGroup | any;
 ...
 onSubmit() {
   ...
   this.userservice.addPharm(this.form.value).subscribe(
   (data: any) => {
  // Success
   console.log(data);
